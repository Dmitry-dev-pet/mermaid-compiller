...
*   **`EditorColumn.tsx`:** Редактор кода Mermaid с подсветкой синтаксиса, панель инструментов (Analyze, язык анализа, Fix, Copy), вкладки Prompt/Build Docs.
...
*   В редакторе/превью есть вкладки Prompt · Chat / Prompt · Build.
