...
- Вкладки Prompt · Chat / Prompt · Build показывают собранный системный промпт, список файлов документации и финальные сообщения, а также оценку токенов (system/messages/total).
