...
- LLM-запросы имеют таймаут и повторы по текущему шагу.
- Таймаут LLM настраивается в панели чата; поле ввода поддерживает ресайз.
...
Обновлено: 2026-01-11. Согласовано с текущей реализацией (проекты/авто-имя, логи с тултипами, notebook build, timeout UI).
