...
- Прозрачное превью промптов (Chat/Build): системный промпт, файлы документации, оценка токенов и переключатель Raw/Redacted.
- Build Docs вкладка с табами файлов и чекбоксами включения/исключения в Build-промпте.
