...
const shouldIncludeLanguageInstruction = (language: string) =>
  language !== "auto";
...
const getDiagramTypeRule = (
  ...
  if (mode === "chat_notebook") {
    if (diagramType === "auto") {
      const list = allowedDiagramTypes?.length
        ? allowedDiagramTypes
        : MAIN_DIAGRAM_TYPES;
  ...
  const detailedTypeRulesRu: Partial<Record<DiagramType, string>> = {
    architecture: [
      ...
      "- Нельзя использовать `->`/`<-` и узлы `A[Text]` как во flowchart.",
      "- Идентификаторы: только ASCII буквы, без цифр и подчёркиваний; подписи — в `[Title]`.",
      "- Если обнаружены `->`/`<-`, перепиши диаграмму целиком в синтаксисе architecture-beta.",
      "Стиль и сложность:",
    ...
    c4: [
      ...
      "- 6–9 элементов и 6–8 связей максимум; излишнее агрегируй.",
      ...
      "- Для C4Component не перечисляй мелкие UI-детали (Button/Toolbar/Sidebar и т.п.).",
      "- Старайся иметь один центральный узел (studio/orchestrator) и связывать остальные через него.",
    ...
    flowchart: [
      ...
      "- Не используй `end` как идентификатор узла (пиши `End`).",
  ...
  const readabilityRulesRu: Partial<Record<DiagramType, string[]>> = {
    architecture: [
      "Читаемость:",
      "- 8–12 сервисов/узлов максимум, 1–2 уровня групп.",
      "- Избегай плотной сетки ребер; оставь главный поток.",
    ],
    block: [
      "Читаемость:",
    ...
    c4: [
      "Читаемость:",
      "- 6–9 элементов и 6–8 связей максимум.",
      "- Один центральный узел, остальные связи через него.",
    ],
    class: [
      "Читаемость:",
      "- 6–12 классов максимум, 8–14 связей.",
      "- Не перегружай класс методами/полями.",
    ],
    er: [
      "Читаемость:",
      "- 6–12 сущностей и 8–14 связей.",
      "- Данные, а не UI-композиция; кардинальности обязательны.",
    ],
    flowchart: [
      "Читаемость:",
      "- 10–18 узлов и 10–22 ребра; одна главная ось (TD/LR).",
      "- Группируй через subgraph, избегай сетки «каждый с каждым».",
    ],
    gantt: [
      "Читаемость:",
      "- 4–10 задач, 1–3 секции.",
      "- Секции и задачи с короткими названиями.",
    ],
    gitGraph: [
      "Читаемость:",
      "- 6–14 коммитов, 1–2 ветки кроме main.",
      "- Избегай длинной истории и лишних merge.",
    ],
    kanban: [
      "Читаемость:",
    ...
    packet: [
      "Читаемость:",
      "- 6–14 полей, без длинных текстов в label.",
      "- Сохраняй логичный порядок диапазонов.",
    ],
    pie: ["Читаемость:", "- 4–8 сегментов.", "- Короткие подписи."],
    quadrantChart: [
      "Читаемость:",
      "- 4–12 точек максимум.",
      "- Короткие подписи, без длинных описаний.",
    ],
    radar: [
      "Читаемость:",
    ...
    sequence: [
      "Читаемость:",
      "- 4–8 участников и 8–20 сообщений.",
      "- Используй alt/opt/loop, избегай «каждый с каждым».",
    ],
    state: [
      "Читаемость:",
    ...
    userJourney: [
      "Читаемость:",
      "- 4–8 шагов, 1–3 роли.",
      "- Описания шагов короткие.",
    ],
    xychart: [
      "Читаемость:",
      "- 2–4 серии, 6–12 точек на серию.",
      "- Короткие названия осей и серий.",
    ],
    zenuml: [
      "Читаемость:",
  ...
  const readabilityRulesEn: Partial<Record<DiagramType, string[]>> = {
    architecture: [
      "Readability:",
      "- Max 8–12 nodes/services, 1–2 group levels.",
      "- Avoid dense edge grids; keep a primary flow.",
    ],
    block: [
      "Readability:",
      "- Max 10–18 blocks, depth <= 2.",
      "- Align by columns, avoid dense edge meshes.",
    ],
    c4: [
      "Readability:",
      "- Max 6–9 elements and 6–8 relationships.",
      "- Use a single hub; connect others through it.",
    ],
    class: [
      "Readability:",
      "- Max 6–12 classes, 8–14 relations.",
      "- Keep class members minimal.",
    ],
    er: [
      "Readability:",
      "- Max 6–12 entities, 8–14 relations.",
      "- Data model only; avoid UI composition.",
    ],
    flowchart: [
      "Readability:",
      "- Max 10–18 nodes and 10–22 edges; one main axis (TD/LR).",
      "- Group with subgraph; avoid all-to-all meshes.",
    ],
    gantt: [
      "Readability:",
      "- 4–10 tasks, 1–3 sections.",
      "- Short task names.",
    ],
    gitGraph: [
      "Readability:",
      "- 6–14 commits, 1–2 branches beyond main.",
      "- Avoid long history and excessive merges.",
    ],
    kanban: [
      "Readability:",
      "- 3–6 columns, 2–6 cards each.",
      "- Short card labels.",
    ],
    mindmap: [
      "Readability:",
      "- 4–8 top-level branches, 2–4 sub-branches each.",
      "- Avoid deep nesting.",
    ],
    packet: [
      "Readability:",
      "- 6–14 fields; keep labels short.",
      "- Keep ranges in logical order.",
    ],
    pie: ["Readability:", "- 4–8 slices.", "- Short labels."],
    quadrantChart: [
      "Readability:",
      "- 4–12 points maximum.",
      "- Short labels only.",
    ...
    radar: [
      "Readability:",
      "- 4–8 metrics and 1–3 series.",
      "- Avoid too many axes.",
    ],
    requirementDiagram: [
      "Readability:",
      "- 6–12 elements, 8–14 relations.",
      "- Keep requirement labels short.",
    ],
    sankey: [
      "Readability:",
      "- 8–16 flows maximum.",
      "- Avoid long chains and crossings.",
    ],
    sequence: [
      "Readability:",
      "- 4–8 participants and 8–20 messages.",
      "- Use alt/opt/loop; avoid everyone-to-everyone.",
    ],
    state: [
      "Readability:",
    ...
    timeline: [
      "Readability:",
      "- 5–12 events maximum.",
      "- Group into 1–3 sections.",
    ],
    treemap: [
      "Readability:",
      "- 6–14 leaves, 2–4 groups.",
      "- Keep node labels short.",
    ],
    userJourney: [
      "Readability:",
      "- 4–8 steps, 1–3 personas.",
      "- Short step descriptions.",
    ],
    xychart: [
      "Readability:",
      "- 2–4 series, 6–12 points each.",
      "- Short axis and series names.",
    ],
    zenuml: [
      "Readability:",
      "- 6–16 steps; avoid deep nesting.",
      "- One main scenario + 1–2 branches.",
    ],
  };

  const appendReadabilityRules = (
    baseRule: string,
    diagramType: DiagramType,
    promptLanguage: PromptLanguage,
  ) => {
    const rules =
      promptLanguage === "Russian"
        ? readabilityRulesRu[diagramType]
        : readabilityRulesEn[diagramType];
    if (!rules?.length) return baseRule;
    return `${baseRule}\n${rules.join("\n")}`;
  };

  const blockGenerateHint =
    promptLanguage === "Russian"
  ...
  if (diagramType && diagramType !== "auto") {
    if (promptLanguage === "Russian") {
      if (mode === "generate") {
        ...
        if (detailed) {
          return appendReadabilityRules(
            sanitizeTypeRuleForGenerate(detailed),
            diagramType,
            promptLanguage,
          );
        }
        ...
        const baseRule =
          diagramType === "block" ? `${base}\n${blockGenerateHint}` : base;
        return appendReadabilityRules(baseRule, diagramType, promptLanguage);
      }
...
export const buildSystemPrompt = (
  ...
  const diagramTypeValues = getDiagramTypeValues(
    args.diagramType,
    args.allowedDiagramTypes,
    mode,
    promptLanguage,
